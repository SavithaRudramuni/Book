//
//  EmptyBookResultController.swift
//  Books
//
...
class EmptyBookResultController:UIViewController {
    ...
    func setUpUI() {
        ...
        blockerView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(EmptyBookResultController.closeAction(_:))))
    }
...
extension EmptyBookResultController: UIViewControllerTransitioningDelegate, UIViewControllerAnimatedTransitioning {
